                ...
                <div class="dn-tab">
                    ...
                    <div class="card">
                        <div class="card-header">
                          <a class="collapsed card-link" href="#">Thông tin nhà trường</a>
                        </div>
                      </div>
                      <div class="card">
                        <div class="card-header d-flex">
                          <a class="card-link" data-toggle="collapse" href="#collapseOne">Quản lý tài khoản sinh viên</a><i class="ml-auto mt-2 fas fa-angle-down"></i>
                        </div>
