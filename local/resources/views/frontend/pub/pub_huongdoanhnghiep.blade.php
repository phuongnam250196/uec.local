                ...
                <div class="thongtinsinhvien">
                    <div class="thongtinsinhvien-main">
                        <div class="thongtinsinhvien-title">
                            <h1 class="thongtinsinhvien-title-exp">hướng về doanh nghiệp</h1>
                        </div>
                            ...
                            <div class="col-md-8 thongtinsinhvien-content">
                                ...
                                <div class="dinhhuong-content-lienquan">
                                    ...
                                    <ul>
                                        ...
                                        <li>Tải tài liệu giới thiệu các ngành đào tạo của Trường Đại Học Thăng Long do <a href="#">sinh viên CLB BOSS</a> và Trung tâm UEC-TLU thực hiện (<a href="#">Gioi-Thieu-Dai-hoc-Thang-Long-UEC</a>, PDF 3,5 MB).</li>
                                        <li>Tham khảo bản quyết định thành lập TTKNĐHDN-ĐHTL : <a href="#">QD-TTKNDHDN</a></li>
                                    </ul>
                                </div>
                            </div>
