                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            ...
                                            <div class="ml-auto"><span class="badge badge-primary">33</span></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex">
                                            <div><a href="#">Tây Ninh</a></div>
                                            <div class="ml-auto"><span class="badge badge-primary">21</span></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex">
                                            <div><a href="#">Thanh Hóa</a></div>
                                            <div class="ml-auto"><span class="badge badge-primary">1</span></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex">
                                            <div><a href="#">Cao Bằng</a></div>
                                            <div class="ml-auto"><span class="badge badge-primary">1</span></div>
                                        </div>
                                    </li>
                                    <li>
