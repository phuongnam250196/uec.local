            ...
            <div class="col-md-4 nav-doc">
                <div class="dn-tab">
                    ...
                    <div class="card">
                        <div class="card-header">
                          <a class="collapsed card-link" href="#">Thông tin cá nhân</a>
                        </div>
                      </div>
                      <div class="card">
                        <div class="card-header d-flex">
                          <a class="card-link" data-toggle="collapse" href="#collapseOne">Hồ sơ ứng tuyển</a><i class="ml-auto mt-2 fas fa-angle-down"></i>
                        </div>
                        <div id="collapseOne" class="collapse show">
                          <ul>
                            <li><a href="#">Taọ hồ sơ xin việc</a></li>
                            <li><a href="#">Hồ sơ 1: Thực tập PHP</a></li>
                            <li><a href="#">Hồ sơ 2: Thực tập .NET</a></li>
                          </ul>
                        </div>
                      </div>
                        <div class="card">
                        <div class="card-header">
                          <a class="collapsed card-link" href="#">Tin tuyển dụng</a>
                        </div>
                      </div>
                      <div class="card">
                        <div class="card-header">
                          <a class="collapsed card-link" href="#">Xem khóa đào tạo</a>
                        </div>
                      </div>
                        
                      <div class="card">
                        <div class="card-header">
                          <a class="collapsed card-link" href="#">Xem kết quả ứng tuyển</a>
                        </div>
                      </div>
                    </div>
                </div>
                ...
                <nav class="nav-child">
                    ...
                    <ul>
                        <li>
                            <div class="d-flex">
                                <p class="mr-auto"><a href="#">Thực tập lập trình php</a></p>
                                <p>Hà Nội</p>
                            </div>
                            <p class="nav-child-p"><a href="#"><i class="far fa-building"></i> Công ty Fsoft</a></p>
                            <div class="nhom-tt">
                                <p class="text-secondary"><i class="far fa-id-badge"></i> Loại hình: Thực tập</p>
                                <p class="text-secondary"><i class="fas fa-dollar-sign"></i> Lương: Thỏa thuận</p>
                            </div>
                            <p class="text-right"><i class="far fa-clock"></i> <small>13 / 05 / 2018</small></p>
                        </li>
                       <li>
                            <div class="d-flex">
                                <p class="mr-auto"><a href="#">Thực tập lập trình php</a></p>
