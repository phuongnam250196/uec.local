                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="file" class="form-control" name="nt_logo">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                       ...
                       <div class="table-responsive">
                          <table class="table">
                            <tbody>
                              ...
                              <tr>
                                <td>Email</td>
                                <td colspan="2">thanglong@gmail.com</td>
                              </tr>
                              <tr>
                                <td>Số điện thoại</td>
                                <td colspan="2">05549894</td>
                              </tr>
                              <tr>
                                <td>website</td>
                                <td colspan="2">thanglong.edu.vn</td>
                              </tr>
                              <tr>
                                <td>Giới thiệu</td>
                                <td colspan="2">djfdsjfj jfjfijfflfjffj</td>
                              </tr>
                              @endforeach
                            </tbody>
                          </table>
                      ...
                      <div class="box-footer clearfix">
                          ...
                          <a href="{{asset('admin\home')}}" class="pull-left btn btn-primary" id="sendEmail">Cập nhật <i class="fa fa-pencil-square" ></i></a>
                      </div>
