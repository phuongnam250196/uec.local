            ...
            <div class="box box-info">
                <div class="box-body table-responsive no-padding dd">
                  <table class="table table-hover">
                    ...
                    <tr>
                      <td>{{$thongtin->id}}</td>
                      <td><a href="#" data-toggle="modal" data-target="#myModal">{{$thongtin->infostudent_name}}</a></td>
                      <td><img src="{{asset('local/storage/app/thongtinSV/'.$thongtin->infostudent_img)}}" width="100"></td>
                      <td>{{$thongtin->infostudent_content}}</td>
