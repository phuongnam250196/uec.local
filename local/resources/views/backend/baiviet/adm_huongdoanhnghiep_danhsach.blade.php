            ...
            <div class="box box-info">
                <div class="box-body table-responsive no-padding dd">
                  <table class="table table-hover">
                    ...
                    @foreach($data as $huong)
                    <tr>
                      <td>{{$huong->id}}</td>
                      <td><a href="#" data-toggle="modal" data-target="#myModal">{{$huong->towardbusiness_name}}</a></td>
                      <td><img src="{{asset('local/storage/app/huongdoanhnghiep/'.$huong->towardbusiness_img)}}" width="100"></td>
                      <td>{{$huong->towardbusiness_content}}</td>
