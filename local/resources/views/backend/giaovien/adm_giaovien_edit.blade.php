                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="file" class="form-control" name="gv_img" value="{{$teach->teacher_img}}}">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label>Khoa</label>
                                        <input required type="text" class="form-control" value="{{$teach->teacher_science}}" name="gv_science">
                                    </div>
                                    <div class="form-group">
