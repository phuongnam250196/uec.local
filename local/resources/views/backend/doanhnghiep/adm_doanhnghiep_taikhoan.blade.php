                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" name="dn_user_pass">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" name="dn_user_pass_2">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="#" title="logo thôi mà"><img id="image-avatar" style="width: 100%"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>{{$u->area_name}}</td>
                                <td><a href="{{asset('admin/doanhnghiep/taikhoan/edit/'.$u->id)}}"><i class="fa fa-edit"></i></a></td>
                                <td><a href="{{asset('admin/doanhnghiep/taikhoan/delete/'.$u->id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa tài khoản này không ???')"><i class="fa fa-trash-o"></i></a></td>
                              </tr>
                              @endforeach
                            </tbody>
                          </table>
            ...
            $($selectUser).change(function(){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        $('#image-avatar').attr('src','{{asset('local/storage/app/public/')}}/' +data.enterprise_logo+'?'+new Date())
                        console.log(data)
                    },
                    errors: function (err) {
                        console.log(err)
